...
<body>
    <header>
        <div class="language-selection bottom-left">
            <a href="Acceuil.php"><img class="language-flag" src="image/french-flag.png" alt="French Flag"></a>
            <a href="AcceuilEngl.php"><img class="language-flag" src="image/english-flag.png" alt="English Flag"></a>
        </div>
        ...
        <nav>
            <ul>
                <li><a href="AcceuilEngl.php">Home</a></li>
